...
nyt_bestsellers_books = nyt_bestsellers
nyt_bestsellers_books.add_title("IT ENDS WITH US", "Colleen Hoover")
nyt_bestsellers_books.add_title("LIVE WIRE", "Kelly Ripa")
...
print(nyt_bestsellers.display_books())
